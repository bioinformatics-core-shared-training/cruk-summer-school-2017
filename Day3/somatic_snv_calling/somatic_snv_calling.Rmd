...
* Statistical approaches to calling SNVs
...
* Sensitivity and specificity of a function of the biology, the sample and data quality, and the calling method.
...
[ICGC benchmarking exercise](https://www.ncbi.nlm.nih.gov/pubmed/26647970)
...
* 6 synthetic datasets based on cell line sequenced to 80x

    - BAM randomly sampled into 2 non-overlapping subsets of equal size, mutations added to one using BAMSurgeon
