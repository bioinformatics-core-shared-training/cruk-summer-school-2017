...
* <span>Ideally need to test filters on separate dataset to that used for training (danger of overfitting)</span>
...
* Low depth in normal can cause germline variants to appear as somatic due to insufficient sampling

<div style="line-height: 50%;"><br></div>

* <span>An approach to detecting likely artefacts is to look for the variant in a panel of unrelated normal samples</span>

    * <span>Filters both polymorphisms and locations prone to aberrant mapping or systematic sequencing artifacts</span>

<span style="font-size: 75%">[Jones et al., 2016](https://www.ncbi.nlm.nih.gov/pubmed/27930805)</span>
