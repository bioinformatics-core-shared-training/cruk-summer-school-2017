...
Established in 2001 as a means of distributing tools for the analysis and comprehension of high-throughput genomic data in R. Initially focussed on microarrays, but now has many tools for NGS data
...
- [Support forum](https://support.bioconductor.org/)
  + means of communicating with developers and power-users
...
- [Conferences]()
    + upcoming conference in Cambridge
...
Markdown is a very simple way of writing a template to produce a pdf, HTML or word document. The compiled version of this document is available online and is more convenient to browse.
...
- Which row in the data frame contains the entry with the highest population?
- Which row in the data frame contains the entry with the lowest life expectancy?
...
As an aside, what is that outlier on the GDP axis?
